...
An RPM of neatvnc 0.9.6 that can offload H.264 encoding to an NVIDIA GPU, so
...
That produces `neatvnc-0.9.6-1.el10.nvenc.x86_64.rpm` and its `-devel`,
...
rpm -Uvh neatvnc-0.9.6-1.el10.nvenc.x86_64.rpm
```

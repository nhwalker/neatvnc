...
# hypothetical future EPEL 0.9.6-1, so the runtime image should exclude
...
%changelog
* Sat Aug 22 2026 Nathan Walker <nathan.h.walker@gmail.com> - 0.9.6-1
- Initial package of neatvnc 0.9.6 with NVENC H.264 support
